        ...
        <nav>
            ...
            <div className={`transition-all duration-1000 ${lastScrollY === 0 ? 'hidden' : ''} md:hidden`}>
                ...
                bottom-10 min-h-fit rounded-r-xl flex flex-col pl-5 pr-5 w-fit`}>
                    <div>
                        <div onClick={togglePanel} className="text-blue-950 p-5 text-xl font-mono font-semibold space-y-3">
                            <div className={styles.nav_item} onClick={() => scrollToSection("aboutMe")}>
                                <span className='text-green-700'>01.</span> About Me</div><hr></hr>
                            {/* <div className={styles.nav_item} onClick={() => scrollToSection("education")}>
                                <span className='text-green-700'>02.</span> Education</div><hr></hr> */}
                            <div className={styles.nav_item} onClick={() => scrollToSection("experience")}>
                                <span className='text-green-700'>02.</span> Experience</div><hr></hr>
                            <div className={styles.nav_item} onClick={() => scrollToSection("projects")}>
                                <span className='text-green-700'>03.</span> Projects</div><hr></hr>
                            <div className={styles.nav_item} onClick={() => scrollToSection("certificates")}>
                                <span className='text-green-700'>04.</span> Certificates</div><hr></hr>
                        </div>
                    </div>
                </div>
            </div>
            ...
            {/* Desktop Navigation */}
            <div id="navbar" className={`z-50 items-center px-10 fixed bg-my-blue transition-transform duration-300 ease-in-out
