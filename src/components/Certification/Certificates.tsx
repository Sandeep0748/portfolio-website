...
function Certificates() {
    ...
    return (
        <div id="certificates" className="space-y-10">
            <h1 className={`${pageStyles.section_heading} text-4xl font-bold`}><span className={pageStyles.numbering}>04.</span> Certifications</h1>
                    ...
                    <div className="relative w-full flex flex-col items-center justify-center p-4 gap-y-5">
                        ...
                        <div className="relative w-full flex items-center justify-center">
                            {activeCertificate && (
                                ...
                                <img
                                    src={`${process.env.PUBLIC_URL}/images/certificates/${activeCertificate.file}`}
