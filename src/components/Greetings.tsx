                ...
                <div className="flex flex-col justify-evenly items-center  font-mono font-bold space-y-5">
                    ...
                    <FadeInSection>
                        <div className="flex  gap-2 md:gap-5 text-xl md:text-2xl lg:text-3xl xl:text-4xl 2xl:text-5xl">
                            ...
                            <div className="text-blue-400">I am Sandeep</div>
                        </div>
                    </FadeInSection>
                    ...
                    <div className="flex justify-center">
                        <div className="leading-5 bg-gray-900 p-4 rounded-md shadow-lg w-fit text-blue-500 text-left text-xs md:text-base lg:text-xl xl:text-2xl font-mono">
                            <span className="pl-4 md:pl-10 lg:pl-16 xl:pl-20 2xl:pl-28 text-slate-300 font-mono">
  const <span className="text-yellow-400">me</span> = 
  [<span className="text-green-400">'Front-end'</span>, <span className="text-green-400">'Back-end'</span>]
  .<span className="text-orange-500">map</span>(
  <span className="text-yellow-500">role</span> =&gt; 
  <span className="text-green-400">`${'{role} Developer'}`</span>)
  .<span className="text-orange-500">join</span>(
  <span className="text-green-400">' &amp; '</span>)
  =&gt; <span className="text-cyan-400 font-bold">"MERN Stack Developer"</span>;
</span>
