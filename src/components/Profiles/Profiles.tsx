...
export default function Profiles() {
    ...
    // ${styles.animate_fade_in_left}
    return (
        <div id="profiles" className="flex flex-wrap items-center justify-center">
            <div className={`${styles.animate_fade_in_left} ${styles.animate_parent} w-20 md:w-40 lg:w-60`}>
                <a
                ...
                >
                    <svg className={styles.icon_size} version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
		...
		c3.8-9.6,12.1-19.6,27-19.6c19.5,0,28.3,14.8,28.3,36.4v82.6H241v-88.8C241,369.9,213.2,346.9,177.7,346.9z"/>
                    ...
                    <h1 className={styles.profile_text}>LinkedIn</h1>
                </a>
            </div>
            <div className={`${styles.animate_fade_in_left} ${styles.animate_parent} w-20 md:w-40 lg:w-60`}>
                <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    href='https://github.com/Sandeep0748'
                >
                    <svg className={styles.icon_size}
                    ...
                    <h1 className={styles.profile_text}>GitHub</h1>
                </a>
            </div>
            <div className={`${styles.animate_fade_in_left} ${styles.animate_parent} w-20 md:w-40 lg:w-60`}>
                <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    href='https://www.hackerrank.com/profile/sandeepkyadav017'
                >
                    <svg className={styles.icon_size} viewBox="2 2 28 29" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <h1 className={styles.profile_text}>HackerRank</h1>
                </a>
            </div>
